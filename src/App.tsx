          ...
          >
            ...
            >
              ...
              <div className="flex gap-6 justify-start">
                {[
                  { icon: <Facebook size={24} />, href: "https://www.facebook.com/share/1BLPjEKSPt/?mibextid=wwXIfr", label: "Facebook" },
                  { icon: <Instagram size={24} />, href: "https://www.instagram.com/fitrevive_physiotherapy?igsh=NW5kNWUwbWVrdzk3&utm_source=qr", label: "Instagram" },
                  ...
                  <a 
                    ...
                    aria-label={`Follow FitRevive on ${social.label}`}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
              ...
              <motion.a 
                ...
                aria-label="Chat with FitRevive on WhatsApp"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                {[
                  { icon: <Facebook size={18} />, href: "https://www.facebook.com/share/1BLPjEKSPt/?mibextid=wwXIfr", label: "Facebook" },
                  { icon: <Instagram size={18} />, href: "https://www.instagram.com/fitrevive_physiotherapy?igsh=NW5kNWUwbWVrdzk3&utm_source=qr", label: "Instagram" },
